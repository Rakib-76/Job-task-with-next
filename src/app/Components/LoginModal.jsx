...
const LoginModal = ({ open, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center">
      ...
      {/* Modal Content */}
      <div className="relative z-50 w-full max-w-[960px] mx-4">
        {/* ===== Login Form from LoginCard ===== */}
        <div
        ...
        >
          ...
          <div className="flex flex-col items-center mt-16 mb-8">
            ...
            <div className="w-[400px] space-y-3">
              ...
              {/* Password */}
              <div className="flex items-center bg-white rounded-md px-3 h-[46px] relative">
                ...
                >
                  ...
                  {/* You could replace with FaEye/HiOutlineEyeOff logic if you want */}
                </button>
              </div>
